...
def generate_pdf_report(sections: list, ad_insights_df=None,full_ad_insights_df=None, currency_symbol=None, split_charts=None,demographic_df=None, platform_df=None) -> StreamingResponse:
            ...
            if section_title.strip().upper() == "KEY METRICS":
                    ...
                    if full_ad_insights_df is not None and 'campaign_name' in full_ad_insights_df.columns:
                        ...
                        # ────────────── Chart 3: ROAS Split ──────────────
                            ...
                            table_y = PAGE_HEIGHT - TOP_MARGIN - 1200
                            summary_table.wrapOn(c, PAGE_WIDTH, PAGE_HEIGHT)
                            summary_table.drawOn(c, LEFT_MARGIN, table_y)
